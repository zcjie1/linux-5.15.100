...
static inline void sched_submit_work(struct task_struct *tsk)
{
	 ...
	 * already acquired.
	 */
	// TASK_RTLOCK_WAIT表示当前进程正在阻塞(自旋)等待锁资源
	// 若此时进行调度，则容易发送死锁
...
void __init sched_init(void)
{
	...
	// 将init_task进程的权重设置为最低值，作为IDLE进程
	...
	// 内核线程(init_tasl)共享用户进程的虚拟地址空间，不需要刷新TLB
