...
noinline void __ref rest_init(void)
{
	 ...
	 */
	pid = kernel_thread(kernel_init, NULL, CLONE_FS); // sched_init_smp()即在kernel_init函数中执行
	/*
...
asmlinkage __visible void __init __no_sanitize_address start_kernel(void)
{
	...
	*/
	 ...
	 */
	sched_init(); // 将init-task进程标记为idle进程(权重降至最低值)，待rest_init完成，0号进程真正转换为idle进程
	...
	// 生成1号进程init、2号进程kthreadd，并将init_task进程转为idle进程
	arch_call_rest_init();
